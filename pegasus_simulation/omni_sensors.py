...
class StereoCamera():
    ...
    def __init__(self, topic_prefix, drone_prim, body_prim, vehicle_id:int=0, resolution:tuple=(640, 480)):
        self.topic_prefix = topic_prefix
        self.drone_prim = drone_prim
    ...
    def _initialize_camera(self):
        stereo_prim = XFormPrim(
            prim_path = self.body_prim.prim_path + "/stereo_camera",
        ...
        left_camera = Camera(
            prim_path=left_prim.prim_path + "/camera",
            resolution=self.resolution,
            translation=(0, 0, 0.0),
        )
        right_camera = Camera(
            prim_path=right_prim.prim_path + "/camera",
            resolution=self.resolution,
            translation=(0, 0, 0.0),
        )
    ...
    def _publish_camera(self):
        ...
        prim_path = self.drone_prim.prim_path
        self.omni_graphs.stereo_camera_graph(prim_path, namespace, self.stereo_prim, self.camera_prims, self.resolution)
        return
