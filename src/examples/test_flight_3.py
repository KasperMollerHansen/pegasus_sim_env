...
def generate_coordinates():
    ...
    coordinates = [[0.0, 0.0, 100.0], 
                      [180.0, -8.0, 125.0], [200.0, -8.0, 125.0], 
                      [180.0, -8.0, 135.0],
                      [180.0, -13.0, 135.0], [174.0, -13.0, 142.0], [160.0, -13.0, 155.0],
                      [160.0, -4.0, 155.0],[174.0, -4.0, 142.0], [188.0, -4.0, 130.0],
                      [188.0, -4.0, 140.0], [200.0, 0.0, 140.0], [200.0, 0.0, 120.0],
                      [210.0, -4.0, 124.0], [228.0, -4.0, 130.0], [250.0, -4.0, 135.0],
                      [250.0, -13.0, 135.0],[228.0, -13.0, 130.0], [210.0, -13.0, 124.0],
                      [198.0, -13.0, 107.0], [193.0, -13.0, 90.0], [188.0, -13.0, 67.0],
                      [188.0, -4.0, 67.0], [193.0, -4.0, 90.0], [198.0, -4.0, 107.0], 
                      [200.0, -4.0, 120.0], 
                      [185.0, 0.0, 130.0], [20.0, 0.0, 105.0]] # Initial points to start from
    yaw = [[0.0], 
           [0.0], [0.0],
           [0.0],
